        ...
        <>
            ...
            <ProfilePageWrapper>
                <ProfileDataWrapper>
                    ...
                    <ButtonWrapper>
                        <FollowButtonProfile onClick={onFollowButtonClick}
                                             isFollowed={isUserFollowed}>{isUserFollowed ? 'FOLLOWING' : 'FOLLOW'}</FollowButtonProfile>
                    </ButtonWrapper>
                </ProfileDataWrapper>
                <UserActivity user_id={profileData?._id} username={profileData?.username}/>
            </ProfilePageWrapper>
        </>
    )
};